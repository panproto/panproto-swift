...
This package binds the [`panproto-c`](https://github.com/panproto/panproto/blob/v0.73.0/crates/panproto-c) C ABI. It
...
`Sigma` transport. [The vocabulary in plain terms](https://github.com/panproto/panproto/blob/v0.73.0/book/src/explanation/decoder-ring.md)
defines both.
...
- [Swift SDK reference](https://github.com/panproto/panproto/blob/v0.73.0/book/src/reference/sdk-swift.md)
- [Install the Swift SDK](https://github.com/panproto/panproto/blob/v0.73.0/book/src/how-to/install/swift.md)
- [Define a schema from Swift](https://github.com/panproto/panproto/blob/v0.73.0/book/src/how-to/define-schema/swift.md)
- [C ABI contract](https://github.com/panproto/panproto/blob/v0.73.0/crates/panproto-c/CONTRACT.md)
...
[MIT](https://github.com/panproto/panproto/blob/v0.73.0/LICENSE)
